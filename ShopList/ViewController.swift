...
class ViewController: UIViewController,UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        //navigator kısmına buton koymak normal buton kodundan farklı
    ...
    @objc func verileriAl() {
        ...
        fetchRequest.returnsObjectsAsFaults = false //veri çekerken yazılıyor çok büyük veriler için. burda yazmasak da olur
        do{
                    ...
                    for sonuc in sonuclar as! [NSManagedObject] {
                        ...
                        if let id = sonuc.value(forKey: "id") as? UUID {
                            if id == idDizisi[indexPath.row]{
                                ...
                                self.tableView.reloadData()   //veriler edeğişti kendini güncelle
